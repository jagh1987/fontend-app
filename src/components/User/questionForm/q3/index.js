        ...
        <div className="row">
            <div className="row">
                <div className="form-inline mx-auto">
                    ...
                    <div className="form-group mb-2">
                        <label name="staticA" className="sr-only">a</label>
            ...
            <div className="row">
                <div className="form-inline mx-auto">
                    <div className="form-group mb-2">
                        <label name="staticHe" className="sr-only">He</label>
                    ...
                    <div className="form-group mb-2">
                        <label name="staticA2" className="sr-only">a</label>
            ...
            <div className="row">
                <div className="form-inline mx-auto">
                    <div className="form-group mb-2">
                        <label name="staticThey" className="sr-only">They</label>
                    ...
                    <div className="form-group mb-2">
                        <label name="staticgirls" className="sr-only">girls</label>
            ...
            <div className="row">
                <div className="form-inline mx-auto">
                    <div className="form-group mb-2">
                        <label name="staticShe" className="sr-only">She</label>
                    ...
                    <div className="form-group mb-2">
                        <label name="staticagirl" className="sr-only">a girl</label>
